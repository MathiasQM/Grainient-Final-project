...
<template>
    <div class="profile-content">
        <div class="profile-nav-container">
            <div :class="profileTab.explore ? 'profile-nav-item profile-nav-active' : 'profile-nav-item'" @click="profileTab.explore = true, profileTab.collections = false, profileTab.loved = false, profileTab.settings = false">
                <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10 20C14.9706 20 19 15.7467 19 10.5C19 5.25329 14.9706 1 10 1C5.02944 1 1 5.25329 1 10.5C1 15.7467 5.02944 20 10 20Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M14 6L12 12L6 14L8 8L14 6Z" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
            <div :class="profileTab.collections ? 'profile-nav-item profile-nav-active' : 'profile-nav-item'" @click="profileTab.collections = true, profileTab.explore = false,profileTab.loved = false, profileTab.settings = false">
                <svg width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21 16.1111C21 16.6121 20.7893 17.0925 20.4142 17.4468C20.0391 17.801 19.5304 18 19 18H3C2.46957 18 1.96086 17.801 1.58579 17.4468C1.21071 17.0925 1 16.6121 1 16.1111V2.88889C1 2.38792 1.21071 1.90748 1.58579 1.55324C1.96086 1.19901 2.46957 1 3 1H8L10 3.83333H19C19.5304 3.83333 20.0391 4.03234 20.4142 4.38658C20.7893 4.74081 21 5.22126 21 5.72222V16.1111Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div class="profile-tab-content-container">
            ...
            <Explore v-if="profileTab.explore"/>
            <Collections v-if="profileTab.collections"/>
            <Loved v-if="profileTab.loved"/>
            <Settings v-if="profileTab.settings"/>
        </div>
    </div>
</template>
